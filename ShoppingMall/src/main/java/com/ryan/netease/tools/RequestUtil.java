package com.ryan.netease.tools;
...
public class RequestUtil {
        ...
        while (names.hasMoreElements()) {
            ...
            if (values.length == 1) {
                ...
                if (val.length() > 0) {
                    ...
                    params.put(key, (date == null ? val : val));
                } else if (emptiable) {
                    params.put(key, "");
                }
            } else {
	...
	public static Map<String, Object> initParams(HttpServletRequest request) {
